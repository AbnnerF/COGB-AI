...
🌟 Sua jornada Pokémon começou!` });
    ...
    async function obterUrlGifAcao(categoria) {
      ...
      if (categoria === 'kiss') {
        fontes.push({ nome: 'Nekos.life', url: 'https://nekos.life/api/v2/img/kiss', extrair: dados => dados?.url });
      }
      if (categoria === 'hug') {
        fontes.push({ nome: 'Gifukai', url: 'https://api.gifukai.com/v1/hug', extrair: dados => dados?.url });
      }
