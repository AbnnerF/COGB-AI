...
// Servidor HTTP mínimo para o Render Web Service detectar uma porta aberta.
// O bot do WhatsApp continua funcionando normalmente em paralelo.
const http = require('http');
const RENDER_PORT = Number(process.env.PORT) || 10000;

http.createServer((req, res) => {
  res.writeHead(200, { 'Content-Type': 'text/plain; charset=utf-8' });
  res.end('CHAIM-BOT online');
}).listen(RENDER_PORT, '0.0.0.0', () => {
  console.log(`🌐 Servidor HTTP do Render ativo na porta ${RENDER_PORT}`);
});
