...
const COMANDOS_CORRIGIVEIS = [
  ...
  'rpg', 'levels', 'inimigos', 'amongus', 'among', 'task', 'report', 'vote', 'skip', 'inimigo', 'historia', 'história', 'inventario', 'inventário', 'battle', 'party', 'create', 'cancel', 'perfil', 'hug', 'punch', 'imagem', 'img',
];
